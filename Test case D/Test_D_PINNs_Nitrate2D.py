...
class PINN:
    ...
    def __init__(self, soil, size, layers, LAA):
       #nb of collocation points: size = [res, ic, leftbc, rightbc, upbc, dwbc]
        ...
        [self.t_ubleft, self.x_ubleft, self.z_ubleft] = [self.get_collocations([soil[0],self.Rs,soil[2],soil[2],soil[4],soil[5]], self.n_ub_left)[0],self.get_collocations([soil[0],self.Rs,soil[2],soil[2],soil[4],soil[5]], self.n_ub_left)[1],self.get_collocations([soil[0],self.Rs,soil[2],soil[2],soil[4],soil[5]], self.n_ub_left)[2]]
        [self.t_ubright, self.x_ubright, self.z_ubright] = [self.get_collocations([self.Rs, soil[1],soil[2],soil[2],soil[4],soil[5]], self.n_ub_center)[0],self.get_collocations([self.Rs, soil[1],soil[2],soil[2],soil[4],soil[5]], self.n_ub_center)[1],self.get_collocations([self.Rs, soil[1],soil[2],soil[2],soil[4],soil[5]], self.n_ub_center)[2]]
