...
class MPINN:
    ...
    def __init__(self, soil, size, layers, LAA):
       #nb of collocation points: size = [res, ic, leftbc, rightbc, upbc, dwbc]
        ...
        self.weights_c, self.biases_c, self.A_c = self.initialize_NN(self.layers)

        # data
        [self.t_res, self.x_res, self.z_res] = [self.get_collocations(soil, self.n_res)[0],self.get_collocations(soil, self.n_res)[1],self.get_collocations(soil, self.n_res)[2]]
        [self.t_ic, self.x_ic, self.z_ic] = [self.get_collocations(list(np.append(soil[0:5],0)), self.n_ic)[0],self.get_collocations(list(np.append(soil[0:5],0)), self.n_ic)[1],self.get_collocations(list(np.append(soil[0:5],0)), self.n_ic)[2]]
        [self.t_ub, self.x_ub, self.z_ub] = [self.get_collocations([soil[0],soil[1],soil[2],soil[2],soil[4],soil[5]], self.n_ub_left)[0],self.get_collocations([soil[0],soil[1],soil[2],soil[2],soil[4],soil[5]], self.n_ub_left)[1],self.get_collocations([soil[0],soil[1],soil[2],soil[2],soil[4],soil[5]], self.n_ub_left)[2]]
        [self.t_lb, self.x_lb, self.z_lb] = [self.get_collocations([soil[0],soil[1],soil[3],soil[3],soil[4],soil[5]], self.n_lb)[0],self.get_collocations([soil[0],soil[1],soil[3],soil[3],soil[4],soil[5]], self.n_lb)[1],self.get_collocations([soil[0],soil[1],soil[3],soil[3],soil[4],soil[5]], self.n_lb)[2]]
        [self.t_left, self.x_left, self.z_left] = [self.get_collocations([soil[0],soil[0],soil[2],soil[3],soil[4],soil[5]], self.n_left)[0],self.get_collocations([soil[0],soil[0],soil[2],soil[3],soil[4],soil[5]],self.n_left)[1],self.get_collocations([soil[0],soil[0],soil[2],soil[3],soil[4],soil[5]], self.n_left)[2]]
        [self.t_right, self.x_right, self.z_right] = [self.get_collocations([soil[1],soil[1],soil[2],soil[3],soil[4],soil[5]], self.n_right)[0],self.get_collocations([soil[1],soil[1],soil[2],soil[3],soil[4],soil[5]], self.n_right)[1],self.get_collocations([soil[1],soil[1],soil[2],soil[3],soil[4],soil[5]], self.n_right)[2]]
...
def main_loop(soil, size , num_layers, num_neurons, number_random, it):
    ...
    model = MPINN(soil, size, layers, LAA=True) 
    #train
    model.train(it)
    ...
    pred_data.to_csv(f"./Results/Test_C_MPINNs_adaptive_activation_predicted_data.csv")
...
main_loop(soil, size, num_layers[0], num_neurons[0], number_random[0], 20000)
